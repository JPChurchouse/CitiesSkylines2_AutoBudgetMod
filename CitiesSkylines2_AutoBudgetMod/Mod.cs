...
namespace CitiesSkylines2_AutoBudgetMod
{
  public class Mod : IMod
  {
    public static ILog log = LogManager.GetLogger($"{nameof(CitiesSkylines2_AutoBudgetMod)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
    ...
    public void OnLoad(UpdateSystem updateSystem)
    {
      ...
      AssetDatabase.global.LoadSettings(nameof(CitiesSkylines2_AutoBudgetMod), m_Setting, new Setting(this));
    }
